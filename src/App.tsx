  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {/* Banner - Client-side & Attribution */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-6 text-center space-y-2">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-500 opacity-75">
        ...
        {/* Footer */}
        <footer className="text-center text-gray-400 dark:text-gray-500 text-xs py-4">
          v2.2 • Multi-line cell support • Transpose • Build: {new Date().toISOString().split('T')[0]}
        </footer>
      </div>
    </div>
  );
